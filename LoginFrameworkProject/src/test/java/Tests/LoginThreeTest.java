...
public class LoginThreeTest extends BaseTest{
	...
	public void loginWithNoMailIdAndPassword(String password, String expectedResult) throws InterruptedException {
		test = extent.createTest("login with no mailid and password");
	...
	public Object[][] getLoginData() {
		...
		Object[][] data = {{"onlypassword123", "Success"}};
