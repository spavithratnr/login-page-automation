...
public class LoginFiveTest extends BaseTest {
	...
	public void loginWithNoMailIdAndNoPassword(String expectedResult) throws InterruptedException {
		test = extent.createTest("login with no mailid and no password");
